...
ROOT_DIR = "C:\Users\kavya\Downloads\tomato_segmentation using mask_rcnn"
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 3, "Tomato_Bacterial_Spot")
        self.add_class("object", 2, "Tomato_Early_Blight")   
        self.add_class("object", 2, "Tomato_Healthy")
        self.add_class("object", 2, "Tomato_Late_Blight")
        self.add_class("object", 2, "Tomato_Leaf_Spot")
        self.add_class("object", 2, "Tomato_mosaic_Virus")
        ...
        for a in annotations:
            ...
            name_dict = {"Tomato_Bacterial_Spot":1,"Tomato_Early_Blight":2,"Tomato_Healthy":3,"Tomato_Late_Blight":4,"Tomato_mosaic_virus":5}
...
def train(model):
    ...
    dataset_train.load_custom("C:\Users\kavya\Downloads\tomato_segmentation using mask_rcnn\datasets", "train")
    
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("C:\Users\kavya\Downloads\tomato_segmentation using mask_rcnn\datasets", "val")
    dataset_val.prepare()
